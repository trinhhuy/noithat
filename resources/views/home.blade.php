        ...
        <div class="container">
            <div class="visit-place">
                <div class="section-heading mrgt7x mrgb7x">
                    <h3><span>BEST PLACE TO VISIT</span></h3>
                </div>
                <div class="places mrgb7x">
                    <div class="col-md-4 col-sm-6">
                        <div class="place-img"> <img src="images/best-place-1.jpg" class="img-responsive" alt="#"/>
                            <div class="place-text">
                                <h2>TRAVEL</h2>
                                <a href="#">Great sightseeing</a> </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="place-img"> <img src="images/best-place2.jpg" class="img-responsive" alt="#"/>
                            <div class="place-text">
                                <h2>LOCATION</h2>
                                <a href="#">Best place to stay</a> </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="place-img"> <img src="images/best-place3.jpg" class="img-responsive" alt="#"/>
                            <div class="place-text">
                                <h2>NATURE</h2>
                                <a href="#">Best place to see</a> </div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4 col-sm-6 animated out" data-delay="0" data-animation="fadeInUp">
                        <div class="property-box border-hover">
                            <div class="appartment-img"><img src="images/propertyimg-1.jpg" class="img-responsive" alt="#" />
                                <div class="detail-btn"> <a href="#" class="more-detail"><i class="fa fa-angle-right"></i>MORE DETAIL</a> </div>
                            </div>
    ...
    <section class="bg-dark parallex mrgb4x">
        <div class="container">
            <div class="inner-text">
                ...
                <span> </span>
                <p>Spend vacations in best hotels and resorts</p>
                <p>find the great place of your choice using different searching options.</p>
            </div>
        </div>
    </section>
    <section>
